...
__global__ void vec_shared_neighbor(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t n __attribute__((unused)), uint32_t n_minus_1 __attribute__((unused)));
int main();
...
__global__ void vec_shared_neighbor(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t n __attribute__((unused)), uint32_t n_minus_1 __attribute__((unused))) {
  ...
  __syncthreads();
  if ((tid < n_minus_1)) {
    uint32_t v0 __attribute__((unused)) = smem[tid];
    uint32_t v1 __attribute__((unused)) = smem[(tid + 1ULL)];
    out.data[tid] = (v0 + v1);
