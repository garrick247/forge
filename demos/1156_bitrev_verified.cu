...
__global__ void bitrev_swap_at(uint32_t* __restrict__ data, uint64_t data_len, uint64_t* __restrict__ rev, uint64_t rev_len, uint64_t n, uint64_t tid) {
  0 /* unhandled */;
  0 /* unhandled */;
  uint64_t rtid = rev[tid];
  0 /* unhandled */;
  0 /* unhandled */;
  if ((rtid > tid)) {
