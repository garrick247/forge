...
__global__ void conv2d_3x3(forge_span_u32_t inp __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t width __attribute__((unused)), uint32_t height __attribute__((unused)));
int main();
        ...
        if ((y < 15ULL)) {
          if ((col > 0ULL)) {
            if (((col + 1ULL) < width)) {
              if ((row > 0ULL)) {
                if (((row + 1ULL) < height)) {
                  uint32_t nw __attribute__((unused)) = smem[(s_idx - 17ULL)];
                  uint32_t n __attribute__((unused)) = smem[(s_idx - 16ULL)];
                  uint32_t ne __attribute__((unused)) = smem[(s_idx - 15ULL)];
                  uint32_t w __attribute__((unused)) = smem[(s_idx - 1ULL)];
                  uint32_t c __attribute__((unused)) = smem[s_idx];
                  uint32_t e __attribute__((unused)) = smem[(s_idx + 1ULL)];
                  uint32_t sw __attribute__((unused)) = smem[(s_idx + 15ULL)];
                  uint32_t s __attribute__((unused)) = smem[(s_idx + 16ULL)];
                  uint32_t se __attribute__((unused)) = smem[(s_idx + 17ULL)];
                  uint32_t val __attribute__((unused)) = ((((((((nw + (2ULL * n)) + ne) + (2ULL * w)) + (4ULL * c)) + (2ULL * e)) + sw) + (2ULL * s)) + se);
