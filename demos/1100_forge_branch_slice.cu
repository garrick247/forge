...
static __host__ __device__ __forceinline__ uint32_t diff_scaled_u32(uint32_t a __attribute__((unused)), uint32_t b __attribute__((unused)));
__global__ void vec_diff_branch(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t n __attribute__((unused)));
int main();
...
__global__ void vec_diff_branch(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    out.data[tid] = diff_scaled_u32(a.data[tid], b.data[tid]);
