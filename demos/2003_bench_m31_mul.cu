...
__global__ void m31_mul_kernel(forge_span_u32_t out __attribute__((unused)), forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), uint64_t n __attribute__((unused)));
int main();
...
__global__ void m31_mul_kernel(forge_span_u32_t out __attribute__((unused)), forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    uint32_t av __attribute__((unused)) = m31_get(a, tid);
    uint32_t bv __attribute__((unused)) = m31_get(b, tid);
    out.data[tid] = m31_mul(av, bv);
