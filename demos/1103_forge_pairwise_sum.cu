...
__global__ void vec_pairwise_sum(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t n __attribute__((unused)), uint32_t n_minus_1 __attribute__((unused)));
int main();
...
__global__ void vec_pairwise_sum(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t n __attribute__((unused)), uint32_t n_minus_1 __attribute__((unused))) {
  ...
  if ((tid < n_minus_1)) {
    uint32_t i_next __attribute__((unused)) = (tid + 1ULL);
    uint32_t v0 __attribute__((unused)) = a.data[tid];
    uint32_t v1 __attribute__((unused)) = a.data[i_next];
    out.data[tid] = (v0 + v1);
