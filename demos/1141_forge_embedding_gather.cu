...
/* ---- FORGE ASSUMPTION AUDIT LOG ----
   Total assumptions: 4
   [ASSUME] /mnt/c/Users/kraken/forge/test/../demos/1141_forge_embedding_gather.fg:34  (< pos ids__len)
             "blockIdx_x < seq_len + seq_len <= ids.len"
   [ASSUME] /mnt/c/Users/kraken/forge/test/../demos/1141_forge_embedding_gather.fg:40  (< token_id_64 vocab_size)
             "caller guarantees in-range token ids"
   [ASSUME] /mnt/c/Users/kraken/forge/test/../demos/1141_forge_embedding_gather.fg:42  (< (+ embed_offset lane) embed__len)
             "token_id<vocab_size + lane<d + vocab_size*d<=embed.len"
   [ASSUME] /mnt/c/Users/kraken/forge/test/../demos/1141_forge_embedding_gather.fg:47  (< (+ out_offset lane) out__len)
