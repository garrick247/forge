...
__global__ void vec_2d_add(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t n __attribute__((unused)), uint32_t width __attribute__((unused)));
int main();
...
__global__ void vec_2d_add(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t n __attribute__((unused)), uint32_t width __attribute__((unused))) {
  ...
  uint32_t y __attribute__((unused)) = blockIdx_x;
  uint32_t idx __attribute__((unused)) = ((y * width) + x);
  if ((idx < n)) {
    uint32_t va __attribute__((unused)) = a.data[idx];
    uint32_t vb __attribute__((unused)) = b.data[idx];
    out.data[idx] = (va + vb);
