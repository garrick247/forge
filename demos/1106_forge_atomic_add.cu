...
__global__ void vec_atomic_sum(forge_span_u32_t a __attribute__((unused)), uint32_t* out_ptr __attribute__((unused)), uint32_t n __attribute__((unused)));
int main();
...
__global__ void vec_atomic_sum(forge_span_u32_t a __attribute__((unused)), uint32_t* out_ptr __attribute__((unused)), uint32_t n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    uint32_t v __attribute__((unused)) = a.data[tid];
    uint32_t _old __attribute__((unused)) = atom_add_u32(out_ptr, v);
