...
__global__ void fri_fold_at(uint32_t* __restrict__ new_evals, uint64_t new_evals_len, uint32_t* __restrict__ old_evals, uint64_t old_evals_len, uint32_t alpha, uint64_t half, uint64_t i) {
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
  uint32_t a = old_evals[i];
  uint32_t b = old_evals[(i + half)];
  0 /* unhandled */;
  0 /* unhandled */;
  uint32_t ab = m31_mul(alpha, b);
  0 /* unhandled */;
  new_evals[i] = m31_add(a, ab);
}

__global__ void fri_unfold_at(uint32_t* __restrict__ new_evals, uint64_t new_evals_len, uint32_t* __restrict__ old_evals, uint64_t old_evals_len, uint32_t alpha, uint64_t half, uint64_t i) {
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
...
__global__ void fri_fold_at_cm31(uint32_t* __restrict__ new_re, uint64_t new_re_len, uint32_t* __restrict__ new_im, uint64_t new_im_len, uint32_t* __restrict__ old_re, uint64_t old_re_len, uint32_t* __restrict__ old_im, uint64_t old_im_len, uint32_t alpha_re, uint32_t alpha_im, uint64_t half, uint64_t i) {
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
  ...
  0 /* unhandled */;
  0 /* unhandled */;
  uint32_t a_re = old_re[i];
  uint32_t a_im = old_im[i];
  uint32_t b_re = old_re[(i + half)];
  uint32_t b_im = old_im[(i + half)];
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
  uint32_t ab_re = cm31_mul_re(alpha_re, alpha_im, b_re, b_im);
  uint32_t ab_im = cm31_mul_im(alpha_re, alpha_im, b_re, b_im);
  0 /* unhandled */;
  0 /* unhandled */;
