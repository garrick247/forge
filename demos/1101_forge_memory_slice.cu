...
__global__ void vec_memory_mix3(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), forge_span_u32_t c __attribute__((unused)), uint32_t n __attribute__((unused)));
int main();
...
__global__ void vec_memory_mix3(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), forge_span_u32_t c __attribute__((unused)), uint32_t n __attribute__((unused))) {
  ...
  if (((tid + 5ULL) < (n + 5ULL))) {
    uint32_t i_b __attribute__((unused)) = (tid + 5ULL);
    uint32_t va __attribute__((unused)) = a.data[tid];
    uint32_t vb __attribute__((unused)) = b.data[i_b];
    uint32_t vc __attribute__((unused)) = c.data[tid];
    a.data[tid] = (((va * 2ULL) + vb) ^ vc);
