...
__global__ void intt_butterfly_at(uint32_t* __restrict__ data, uint64_t data_len, uint32_t* __restrict__ twiddle, uint64_t twiddle_len, uint64_t half_n, uint64_t tid) {
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
  ...
  0 /* unhandled */;
  0 /* unhandled */;
  uint32_t a2 = m31_add(a, b);
  uint32_t d = m31_sub(a, b);
  uint32_t b2 = m31_mul(w, d);
  0 /* unhandled */;
  0 /* unhandled */;
  0 /* unhandled */;
  data[tid] = a2;
