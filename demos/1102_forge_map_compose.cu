...
static __host__ __device__ __forceinline__ uint32_t map_chain_u32(uint32_t av __attribute__((unused)), uint32_t bv __attribute__((unused)), uint32_t cv __attribute__((unused)));
__global__ void vec_map_compose(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), forge_span_u32_t c __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t n __attribute__((unused)));
int main();
...
static __host__ __device__ __forceinline__ uint32_t map_chain_u32(uint32_t av __attribute__((unused)), uint32_t bv __attribute__((unused)), uint32_t cv __attribute__((unused))) {
  uint32_t tmp __attribute__((unused)) = ((av * 3ULL) + 7ULL);
  return ((tmp ^ bv) + cv);
}

__global__ void vec_map_compose(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), forge_span_u32_t c __attribute__((unused)), forge_span_u32_t out __attribute__((unused)), uint32_t n __attribute__((unused))) {
  uint32_t tid __attribute__((unused)) = ((blockIdx_x * blockDim_x) + threadIdx_x);
  if ((tid < n)) {
    out.data[tid] = map_chain_u32(a.data[tid], b.data[tid], c.data[tid]);
