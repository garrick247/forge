...
__global__ void matmul_kloop(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), forge_span_u32_t c __attribute__((unused)), uint32_t m __attribute__((unused)), uint32_t n __attribute__((unused)), uint32_t k __attribute__((unused)));
int main();
...
__global__ void matmul_kloop(forge_span_u32_t a __attribute__((unused)), forge_span_u32_t b __attribute__((unused)), forge_span_u32_t c __attribute__((unused)), uint32_t m __attribute__((unused)), uint32_t n __attribute__((unused)), uint32_t k __attribute__((unused))) {
  ...
  uint32_t num_k_tiles __attribute__((unused)) = (k / 16ULL);
  uint32_t acc __attribute__((unused)) = 0ULL;
  uint32_t kt __attribute__((unused)) = 0ULL;
  {
    while ((kt < num_k_tiles)) {
      uint32_t k_base __attribute__((unused)) = (kt * 16ULL);
      if ((row < m)) {
        uint32_t a_col __attribute__((unused)) = (k_base + x);
        if ((a_col < k)) {
          uint32_t a_idx __attribute__((unused)) = ((row * k) + a_col);
          if ((a_idx < a.len)) {
      ...
      if ((col < n)) {
        uint32_t b_row __attribute__((unused)) = (k_base + y);
        if ((b_row < k)) {
          uint32_t b_idx __attribute__((unused)) = ((b_row * n) + col);
          if ((b_idx < b.len)) {
