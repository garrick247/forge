...
/* ---- FORGE ASSUMPTION AUDIT LOG ----
   Total assumptions: 2
   [ASSUME] /home/garrick/forge/demos/1142_forge_sinusoidal_pe.fg:44  (< idx_e out__len)
             "pos<seq_len + lane<16 + seq_len*32<=out.len"
   [ASSUME] /home/garrick/forge/demos/1142_forge_sinusoidal_pe.fg:45  (< idx_o out__len)
