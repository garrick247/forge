...
/* ---- FORGE ASSUMPTION AUDIT LOG ----
   Total assumptions: 2
   [ASSUME] /home/garrick/forge/demos/1143_forge_argmax_row.fg:35  (< (+ base lane) logits__len)
             "blockIdx_x<gridDim_x + lane<n_classes + gridDim_x*n_classes<=logits.len"
   [ASSUME] /home/garrick/forge/demos/1143_forge_argmax_row.fg:53  (< row out__len)
