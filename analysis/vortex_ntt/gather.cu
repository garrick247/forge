...
__global__ void gather_u32(uint32_t* __restrict__ src, uint64_t src_len, uint32_t* __restrict__ idx, uint64_t idx_len, uint32_t* __restrict__ dst, uint64_t dst_len, uint64_t n) {
...
__global__ void gather_u256(uint32_t* __restrict__ src, uint64_t src_len, uint32_t* __restrict__ idx, uint64_t idx_len, uint32_t* __restrict__ dst, uint64_t dst_len, uint64_t n) {
  uint64_t i = ((blockIdx.x * blockDim.x) + threadIdx.x);
  if ((i < n)) {
    uint32_t j = idx[i];
