...
__global__ void circle_ntt_warp_fused4_forward(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t twiddles_a __attribute__((unused)), forge_span_u32_t twiddles_b __attribute__((unused)), forge_span_u32_t twiddles_c __attribute__((unused)), forge_span_u32_t twiddles_d __attribute__((unused)), uint32_t layer_idx __attribute__((unused)));
int main();
...
__global__ void circle_ntt_warp_fused4_forward(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t twiddles_a __attribute__((unused)), forge_span_u32_t twiddles_b __attribute__((unused)), forge_span_u32_t twiddles_c __attribute__((unused)), forge_span_u32_t twiddles_d __attribute__((unused)), uint32_t layer_idx __attribute__((unused))) {
  ...
  uint64_t stride_a __attribute__((unused)) = (1ULL << ((uint64_t)layer_idx));
  uint64_t stride_b __attribute__((unused)) = (1ULL << ((uint64_t)(layer_idx + 1ULL)));
  uint64_t stride_c __attribute__((unused)) = (1ULL << ((uint64_t)(layer_idx + 2ULL)));
  uint64_t stride_d __attribute__((unused)) = (1ULL << ((uint64_t)(layer_idx + 3ULL)));
  uint64_t h_a __attribute__((unused)) = (tid >> ((uint64_t)(layer_idx + 1ULL)));
  uint64_t h_b __attribute__((unused)) = (tid >> ((uint64_t)(layer_idx + 2ULL)));
  uint64_t h_c __attribute__((unused)) = (tid >> ((uint64_t)(layer_idx + 3ULL)));
  uint64_t h_d __attribute__((unused)) = (tid >> ((uint64_t)(layer_idx + 4ULL)));
  if ((tid < data.len)) {
    if ((h_a < twiddles_a.len)) {
      if ((h_b < twiddles_b.len)) {
        if ((h_c < twiddles_c.len)) {
          if ((h_d < twiddles_d.len)) {
            uint32_t v0 __attribute__((unused)) = reduce_word(data.data[tid]);
            uint32_t t_a __attribute__((unused)) = reduce_word(twiddles_a.data[h_a]);
            uint32_t t_b __attribute__((unused)) = reduce_word(twiddles_b.data[h_b]);
            uint32_t t_c __attribute__((unused)) = reduce_word(twiddles_c.data[h_c]);
            uint32_t t_d __attribute__((unused)) = reduce_word(twiddles_d.data[h_d]);
            uint64_t pa_u64 __attribute__((unused)) = __shfl_xor_sync(0xffffffff, ((uint64_t)v0), stride_a, 32ULL);
            uint32_t pa __attribute__((unused)) = reduce_word(((uint32_t)pa_u64));
            uint32_t v1_raw;
            if (((tid & stride_a) == 0ULL)) {
              uint32_t prod __attribute__((unused)) = m31_mul(pa, t_a);
              v1_raw = m31_add(v0, prod);
            } else {
              uint32_t prod __attribute__((unused)) = m31_mul(v0, t_a);
              v1_raw = m31_sub(pa, prod);
            }
            uint32_t v1 __attribute__((unused)) = reduce_word(v1_raw);
            uint64_t pb_u64 __attribute__((unused)) = __shfl_xor_sync(0xffffffff, ((uint64_t)v1), stride_b, 32ULL);
            uint32_t pb __attribute__((unused)) = reduce_word(((uint32_t)pb_u64));
            uint32_t v2_raw;
            if (((tid & stride_b) == 0ULL)) {
              uint32_t prod __attribute__((unused)) = m31_mul(pb, t_b);
              v2_raw = m31_add(v1, prod);
            } else {
              uint32_t prod __attribute__((unused)) = m31_mul(v1, t_b);
              v2_raw = m31_sub(pb, prod);
            }
            uint32_t v2 __attribute__((unused)) = reduce_word(v2_raw);
            uint64_t pc_u64 __attribute__((unused)) = __shfl_xor_sync(0xffffffff, ((uint64_t)v2), stride_c, 32ULL);
            uint32_t pc __attribute__((unused)) = reduce_word(((uint32_t)pc_u64));
            uint32_t v3_raw;
            if (((tid & stride_c) == 0ULL)) {
              uint32_t prod __attribute__((unused)) = m31_mul(pc, t_c);
              v3_raw = m31_add(v2, prod);
            } else {
              uint32_t prod __attribute__((unused)) = m31_mul(v2, t_c);
              v3_raw = m31_sub(pc, prod);
            }
            uint32_t v3 __attribute__((unused)) = reduce_word(v3_raw);
            uint64_t pd_u64 __attribute__((unused)) = __shfl_xor_sync(0xffffffff, ((uint64_t)v3), stride_d, 32ULL);
            uint32_t pd __attribute__((unused)) = reduce_word(((uint32_t)pd_u64));
            uint32_t v4;
            if (((tid & stride_d) == 0ULL)) {
              uint32_t prod __attribute__((unused)) = m31_mul(pd, t_d);
              v4 = m31_add(v3, prod);
            } else {
              uint32_t prod __attribute__((unused)) = m31_mul(v3, t_d);
              v4 = m31_sub(pd, prod);
            }
            data.data[tid] = v4;
