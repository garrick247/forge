...
__forge_tuple_u64_u64_t m31_butterfly(uint64_t v0 __attribute__((unused)), uint64_t v1 __attribute__((unused)), uint64_t t __attribute__((unused))) {
  ...
  return FORGE_AGG(__forge_tuple_u64_u64_t, new_v0, new_v1);
}
...
__global__ void circle_ntt_layer(forge_span_u64_t data __attribute__((unused)), forge_span_u64_t twiddles __attribute__((unused)), uint64_t layer_idx __attribute__((unused)), uint64_t half_n __attribute__((unused))) {
  ...
  if ((tid < half_n)) {
    uint64_t stride __attribute__((unused)) = (1ULL << layer_idx);
    uint64_t h __attribute__((unused)) = (tid >> layer_idx);
    uint64_t l __attribute__((unused)) = (tid & (stride - 1ULL));
    uint64_t idx0 __attribute__((unused)) = ((h << (layer_idx + 1ULL)) + l);
    ...
    if ((((idx0 < data.len) && (idx1 < data.len)) && (h < twiddles.len))) {
      ...
      uint64_t tmp __attribute__((unused)) = ((v1 * t) % 2147483647ULL);
      uint64_t sum __attribute__((unused)) = (v0 + tmp);
      data.data[idx0] = ((sum >= 2147483647ULL) ? (sum - 2147483647ULL) : sum);
      data.data[idx1] = ((v0 >= tmp) ? (v0 - tmp) : ((2147483647ULL - tmp) + v0));
  ...
  if ((tid < half_n)) {
    ...
    if ((((idx0 < data.len) && (idx1 < data.len)) && (h < twiddles.len))) {
      ...
      if ((v0 >= v1)) {
        ...
        diff = ((2147483647ULL - v1) + v0);
      }
      data.data[idx1] = ((diff * t) % 2147483647ULL);
...
__global__ void circle_ntt_warp_layer(forge_span_u64_t data __attribute__((unused)), uint64_t n __attribute__((unused)), uint64_t stride __attribute__((unused)), uint64_t twiddle __attribute__((unused))) {
  uint64_t tid __attribute__((unused)) = ((blockIdx_x * blockDim_x) + threadIdx_x);
  if ((tid < n)) {
    uint64_t val __attribute__((unused)) = (data.data[tid] % 2147483647ULL);
    uint64_t partner __attribute__((unused)) = __shfl_xor_sync(0xffffffff, val, stride, 32ULL);
    uint64_t lid __attribute__((unused)) = (__builtin_expect(blockDim.x % 32 == 0, 1) ? (threadIdx.x & 31) : (__builtin_trap(), 0));
    uint64_t tw __attribute__((unused)) = (twiddle % 2147483647ULL);
    if ((lid < stride)) {
      uint64_t tmp __attribute__((unused)) = ((partner * tw) % 2147483647ULL);
      uint64_t s __attribute__((unused)) = (val + tmp);
      data.data[tid] = ((s >= 2147483647ULL) ? (s - 2147483647ULL) : s);

    } else {
      uint64_t tmp2 __attribute__((unused)) = ((val * tw) % 2147483647ULL);
      data.data[tid] = ((partner >= tmp2) ? (partner - tmp2) : ((2147483647ULL - tmp2) + partner));
...
__global__ void m31_scale(forge_span_u64_t data __attribute__((unused)), uint64_t scale __attribute__((unused)), uint64_t n __attribute__((unused))) {
  uint64_t tid __attribute__((unused)) = ((blockIdx_x * blockDim_x) + threadIdx_x);
  if ((tid < n)) {
    data.data[tid] = ((data.data[tid] * scale) % 2147483647ULL);
...
__global__ void circle_ntt_batch_layer(forge_span_u64_t columns __attribute__((unused)), forge_span_u64_t twiddles __attribute__((unused)), uint64_t layer_idx __attribute__((unused)), uint64_t half_n __attribute__((unused)), uint64_t n_cols __attribute__((unused)), uint64_t col_stride __attribute__((unused))) {
  ...
  if (((tid < total) && (half_n >= 1ULL))) {
    ...
    uint64_t idx0 __attribute__((unused)) = (((col_idx * col_stride) + (h << (layer_idx + 1ULL))) + l);
    uint64_t idx1 __attribute__((unused)) = (idx0 + stride);
    if ((((idx0 < columns.len) && (idx1 < columns.len)) && (h < twiddles.len))) {
      uint64_t v0 __attribute__((unused)) = (columns.data[idx0] % 2147483647ULL);
      uint64_t v1 __attribute__((unused)) = (columns.data[idx1] % 2147483647ULL);
      uint64_t t __attribute__((unused)) = (twiddles.data[h] % 2147483647ULL);
      uint64_t tmp __attribute__((unused)) = ((v1 * t) % 2147483647ULL);
      uint64_t sum __attribute__((unused)) = (v0 + tmp);
      columns.data[idx0] = ((sum >= 2147483647ULL) ? (sum - 2147483647ULL) : sum);
      columns.data[idx1] = ((v0 >= tmp) ? (v0 - tmp) : ((2147483647ULL - tmp) + v0));
...
__global__ void bit_reverse_m31(forge_span_u64_t data __attribute__((unused)), uint64_t n __attribute__((unused)), uint64_t log_n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    ...
    uint64_t bits __attribute__((unused)) = 0ULL;
    {
      while ((bits < log_n)) {
